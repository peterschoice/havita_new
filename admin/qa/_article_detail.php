...
<div class="table-title gd-help-manual"><?=($isShow == 'y') ? '게시글 보기' : '상세보기'; ?></div>
<table class="table table-cols">
    ...
    <tr>
        <th>내용</th>
        <td colspan="3" style="margin:0px"><?= $listType != 'memo' ? $bdView['data']['workedContents'] : $bdView['data']['memo']; ?></td>
    </tr>
